...
class CheckinTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      onTap: () async {
        await HorarioControle.confirmaPagamento(dados.id,
            onSuccess: onSuccess, onFail: onFail, context: context);
      },
